...
class cadastroclienteControllerEdit
{
    ...
    private function editar()
    {
        ...
        if ($result >= 1) {
            echo "<script>alert('Registro editado com sucesso!');document.location='../view/clientes/index.php';</script>";
        } else {
            echo "<script>alert('Erro ao gravar registro! verifique se o cliente não está duplicado');history.back();</script>";
        }
    }
}
new cadastroclienteControllerEdit();
