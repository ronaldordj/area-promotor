...
<body>	
  ...
  <div class="container">
    ...
    <br>
    <center><h5>Movel In - Área do Distribuidor</h5></center>
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
                <button class="btn btn-primary btn-lg btn-block">
                    <div class="float-left">
                        <a href="../view/ativacoes" class="btn btn-primary btn-lg btn-block" role="button">
                            <img src="../public/svgs/key-branco.png" alt="Entregas Técnicas" height="80px" class="img-rounded">
                            Ativar Produtos
                        </a>
                    </div>
                </button>
