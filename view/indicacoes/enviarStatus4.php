...
$indicacoes = $banco->getAcompanhamento($indicacao);
	foreach ($indicacoes as $linha) {
		...
		$motivofechado    = $linha['Motivofechado'];		
	}
	...
	$body = '
		...
		<body style="margin: 10px;">
			<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">
				...
				<br><strong>Agendado apresentação: </strong>Sim
				<br><strong>Enviado proposta: </strong>Sim
				<br><strong>Fechado: </strong>Não
				<br><strong>Motivo: </strong><p>'.$motivoapr.'</p>
				<br>
				<br>Revenda: 				
